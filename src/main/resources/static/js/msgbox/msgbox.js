...
ZENG.msgbox.loadingAnimationPath = ZENG.msgbox.loadingAnimationPath
		|| ("loading.gif");
ZENG.msgbox.show = function(msgHtml, type, timeout, opts, callBack) {
	...
	opts = opts || {};
	var _s = ZENG.msgbox, template = '<span class="zeng_msgbox_layer" style="display:none;z-index:999999999;" id="mode_tips_v2"><span class="gtl_ico_{type}"></span>{loadIcon}{msgHtml}<span class="gtl_end"></span></span>', loading = '<span class="gtl_ico_loading"></span>', typeClass = [
	...
	if (type == 6) {
		if (masklayer) {
			...
			style = "position:absolute;top:0; left:0; width:100%; height:"
					...
					+ "px;"
					+ "z-index:1000000;opacity:.5; filter:alpha(opacity=50); background: #ccc;"
					+ "-webkit-transition:all 0.3s; -moz-transition:all 0.3s; transition:all 0.3s;";
			masklayer = document.createElement("div");
			masklayer.setAttribute("id", "masklayer");
			masklayer.setAttribute("style", style);
...
ZENG.msgbox._setPosition = function(tips, timeout, topPosition, callBack) {
